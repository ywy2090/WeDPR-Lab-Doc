...
latex_documents = [
  (master_doc, 'WeDPR.tex', u'WeDPR Documentation',
   u'WeDPR Community', 'manual'),
]
...
man_pages = [
    (master_doc, 'WeDPR-Doc', u'WeDPR Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'WeDPR-Doc', u'WeDPR-Doc Documentation',
   author, 'WeDPR Community', 'documents of WeDPR-Doc',
   'Miscellaneous'),
]
